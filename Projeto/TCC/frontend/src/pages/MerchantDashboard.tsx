...
import { getMerchantDashboard, type MerchantDashboard as MerchantDashboardData } from "../services/orderService";
import { PriceTag } from "../components/PriceTag";
import { formatPrice } from "../utils/format";
import { EmptyState } from "../components/EmptyState";
import { BadgeStatus } from "../components/BadgeStatus";
import { PackageIcon, StoreIcon, ZapIcon, ClockIcon } from "../components/Icons";
...
export const MerchantDashboard: React.FC = () => {
  ...
  if (data === null && !error) {
    return (
      <div className="mx-auto flex h-64 max-w-5xl items-center justify-center">
        <span className="text-sm font-medium text-muted">Carregando dashboard...</span>
      </div>
    );
  }
  ...
  if (data.totalVendas === 0 && data.pedidosPorStatus.length === 0) {
    return (
      <div className="mx-auto px-4 py-10 sm:px-6">
        ...
        <EmptyState
          ...
          description="Quando seus produtos forem vendidos, você verá aqui os números da sua loja."
        />
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-ink">Dashboard</h1>
        <p className="mt-1 text-sm text-muted">
          Visão geral das vendas da sua loja na Maxibuy.
        </p>
      </div>
